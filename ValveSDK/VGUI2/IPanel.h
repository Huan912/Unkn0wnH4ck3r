...
namespace vgui
{
	...
	public:
		...
		virtual void Solve2(IPanel* vguiPanel) = 0;
		virtual void Solve3(IPanel* vguiPanel) = 0;
		virtual void Solve4(IPanel* vguiPanel) = 0;
		virtual void Solve5(IPanel* vguiPanel) = 0;
		virtual void Solve6(IPanel* vguiPanel) = 0;
