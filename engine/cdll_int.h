...
typedef HSPRITE__ * HSPRITE;	// handle to a graphic
...
// Added for user input processing
	...
	int(*pfnDrawStringReverse)(int x, int y, const char* const pszString, int r, int g, int b, int a);
...
typedef struct cl_enginefuncs_s
{
	...
	void						(*pfnSPR_DisableScissor)	(void);
	client_sprite_t* (*pfnSPR_GetList)		(char* psz, int* piCount);
	void						(*Unknown1)					(int arg1, int arg2, int arg3); // test
	...
	void(*Unknown5)					();
	void(*Unknown6)					();
	void(*LeaveGameRoom)			(int arg1, int arg2);
	void(*Unknown7)					();
	void(*Unknown8)					();
	void(*Unknown9)					();
	void(*Unknown10)				(const char* arg); // LOAD SOUND
	void(*Unknown11)				();
	void(*Unknown12)				();
	void(*Unknown13)				();
	void(*Unknown14)				();
