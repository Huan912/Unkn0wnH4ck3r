...
namespace ImGui
{
	...
	IMGUI_API void          Purple();   // purple
	IMGUI_API void          Pink();   // purple
	IMGUI_API void          CherryTheme();   // purple
	...
	IMGUI_API bool          Checkbox(const char* label, float* v);
...
#define IMGUI_PAYLOAD_TYPE_COLOR_3F     XorString("_COL3F")    // float[3]: Standard type for colors, without alpha. User code may use this type.
#define IMGUI_PAYLOAD_TYPE_COLOR_4F     XorString("_COL4F")    // float[4]: Standard type for colors. User code may use this type.
