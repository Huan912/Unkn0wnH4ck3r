...
struct efx_api_s
{
	...
	void(*Unknown1)					(int a, int b, int c, int d, int e, int f);
	...
	void(*Unknown4)();
	void(*Unknown5)();
	BEAM* (*R_BeamCirclePoints)		(int type, const Vector& vecStart, const Vector& vecEnd, int modelIndex, float life, float width, float amplitude, float brightness, float speed, int startFrame, float framerate, float r, float g, float b);
